...
public class FundActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fund1);

        webView = findViewById(R.id.web_view);

        webView.setWebViewClient(new WebViewClient(){

            ProgressDialog pd = new ProgressDialog(FundActivity1.this);
        ...
        webView.loadUrl("https://www.smilefoundationindia.org/");
