...
public class NrewsActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nrews3);

        webView = findViewById(R.id.web_view);

        webView.setWebViewClient(new WebViewClient(){

            ProgressDialog pd = new ProgressDialog(NrewsActivity3.this);
        ...
        webView.loadUrl("https://newsnetwork.mayoclinic.org/");
