...
public class AZActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_az2);

        webView = findViewById(R.id.web_view);

        webView.setWebViewClient(new WebViewClient(){

            ProgressDialog pd = new ProgressDialog(AZActivity2.this);
        ...
        webView.loadUrl("https://www.webmd.com/a-to-z-guides/common-topics/default.htm");
