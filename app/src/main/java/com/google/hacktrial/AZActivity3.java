...
public class AZActivity3 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_az3);

        webView = findViewById(R.id.web_view);

        webView.setWebViewClient(new WebViewClient(){

            ProgressDialog pd = new ProgressDialog(AZActivity3.this);
        ...
        webView.loadUrl("https://www.mayoclinic.org/diseases-conditions");
